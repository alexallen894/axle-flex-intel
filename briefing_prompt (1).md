...
Send using the Resend API via send_email.py. The RESEND_API_KEY will be provided in your session instructions. Run:

```
python3 send_email.py \
  --api-key "$RESEND_API_KEY" \
  --to "alex.allen894@gmail.com" \
  --subject "Axle Flex Intel | {date} | {hook}" \
